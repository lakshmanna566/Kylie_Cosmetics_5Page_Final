...
function renderProductsOn(selectorMap){
  const shopEl = document.querySelector(selectorMap && selectorMap.Lips ? selectorMap.Lips : document.getElementById('shop-products'));
  if(!shopEl) return;
  products.forEach(prod=>{
    ...
    if(selectorMap){
      ...
      document.getElementById('shop-products').appendChild(card);
    }
  });
